...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.GetReactionByObjectIdResp"
                                        }
                                    }
                                }
                            ]
        ...
        "/answer/api/v1/v3ex/checkin/sign": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "SignV3exReq",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.SignV3exReq"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.SignV3exResp"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.SignReq"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.SignResp"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ERC20Token"
                        }
                    }
                ],
                "responses": {
        ...
        "/answer/api/v1/v3ex/tokens": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "ListTokenReq",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ListTokenReq"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.ListTokenResp"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "schema.ERC20Token": {
            ...
            "properties": {
                "address": {
                    "description": "Address 代币合约的地址",
                    "type": "string"
                },
                "decimals": {
                    "description": "Decimals 代币的小数位数",
                    "type": "integer"
                },
                "description": {
                    "description": "Description 对代币的描述",
                    "type": "string"
                },
                "id": {
                    "type": "integer"
                ...
                "logoURI": {
                    "description": "LogoURI 代币的图标 URI",
                    "type": "string"
                },
                "name": {
                    "description": "Name 代币的名称",
                    "type": "string"
                },
                "symbol": {
                    "description": "Symbol 代币的简称",
                    "type": "string"
                }
            }
        },
        ...
        "schema.GetReactionByObjectIdResp": {
            "type": "object",
            "properties": {
                "reaction_summary": {
                    "type": "array",
